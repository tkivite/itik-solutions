...
import { MessageSquare, Mail, Twitter, Phone, MapPin,Users,Send } from "lucide-react";
...
const Contact = () => {
  ...
  const text = "Have questions or feedback? We’re here to help!";
  ...
  return (
    <div className="relative text-neutral-dark h-screen">
      ...
      <section className="text-center p-24 bg-transparent">
          <motion.h2
            className="text-4xl font-extrabold mb-6 text-neutral-light"
      ...
      >
        <div className="lg:flex">
          <div className="lg:w-1/2 xl:w-3/5 p-8 sm:p-16 flex flex-col justify-between">
            <div>
              <motion.h2
          ...
          <div className="lg:w-1/2 xl:w-2/5 bg-gradient-to-br from-blue-950 via-blue-900 to-blue-950 p-8 sm:p-16 text-white">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="space-y-3">
                  <Button variant="outline" className=" flex justify-start text-primary-dark   p-4 rounded-lg border border-gray-300 bg-gradient-to-r from-violet-50 via-transparent to-primary-dark bg-[length:200%_100%] bg-left transition-all duration-500 ease-in-out w-full" initial={{ backgroundPosition: "left" }}
